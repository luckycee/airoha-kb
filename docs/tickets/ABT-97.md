...
问题发生在COM100 17:37:22 ，回连手机后，耳机检查到在来电状态发送了 KEY_ACCEPT_CALL ，但是耳机的状态一直没有转换过来保持在来电状态，直到17:37:34 才转到了 APP_[人名10]P_CALLACTIVE ，但是实际上话音信号在手机上(应该在耳机上的)。在22秒到24秒过程中，我发现耳机在不停跟iPhone 13 Pro Max 在AT CMD 通讯，并且在不断对已经配对过的另外一个手机发起回连，这是否有影响；概率十几次有一次；
...
3. 手机B搜索到耳机，并连接，先接连接上A2DP，直到30多秒后才连接上[人名10]P ；

我看到，在连接手机B的过程，耳机还在不停发起对手机A的连接，并且最终手机B的[人名10]P也连接上了，对手机A仍发起连接请求，会不会导致了手机慢？是不是仍有地方需要修改为连接一个手机后，不再发起回连？
